		...
		<section class="accueil">
			...
			<section class="ateliers" ng-controller="ateliersController as ateliersCtrl">
				<section id="atelierContainer">
					...
					<section class="calendar" ng-controller="CalendarController as clndrCtrl">
						<button ng-click="cldrCtrl.nextDay()">NxtDay</button>
						<div id="focusCard"> 
							{{cldrCtrl.focusDate.formatedDate}}
							<div ng-class="{multipleCard:cldrCtrl.focusDate.events.length>1}" class="eventCard" ng-repeat="event in cldrCtrl.focusDate.events">
								{{event.name}}
							</div>
							<div ng-show="cldrCtrl.focusDate.events.length===0">Y'a rien uesh</div>
						</div>
						<button ng-click="cldrCtrl.prevDay()">PrvDay</button>
						<br>
						<div class="dayCard" ng-repeat="day in cldrCtrl.week" ng-click='cldrCtrl.focusOn(day.date)'>
							<h2>{{day.dayOfWeek}}</h2>
